  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-[#1A1A2E]/80 backdrop-blur-md border-b border-white/10 z-50 h-[64px]">
      <div className="h-full px-6 flex items-center justify-between">
        ...
        <form onSubmit={handleSearch} className="hidden md:flex items-center bg-white/[0.03] backdrop-blur-sm rounded-lg px-4 py-2 w-96 border border-white/10 focus-within:border-white/20 transition-all duration-300">
          ...
          <input
            ...
            className="bg-transparent border-none outline-none text-sm ml-3 flex-1 text-white/70 placeholder:text-white/20 font-light"
          />
          ...
          <div className="relative">
            ...
            {showNotifications && (
              <>
                ...
                <div className="absolute right-0 top-full mt-2 w-80 bg-[#1A1A2E]/90 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden">
